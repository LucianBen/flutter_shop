class DetailsModel {
  ...
  DetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new GoodDetails.fromJson(json['data']) : null;
  }
...
class GoodDetails {
  ...
  GoodDetails({this.goodInfo, this.goodComments, this.advertesPicture});

  GoodDetails.fromJson(Map<String, dynamic> json) {
